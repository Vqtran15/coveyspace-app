    ...
    <div className="min-h-screen bg-sunrise-50 overflow-x-hidden lg:pl-56" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
      ...
      >
        <Routes>
          ...
          <Route path="/chat"      element={<ChatTab session={session} displayName={displayName} groupId={groupId} isAdmin={isAdmin} onRead={() => setUnreadChatCount(0)} onOpenSettings={() => setSettingsOpen(true)} upcoming={upcoming} onOpenBirthdays={() => setBirthdayOpen(true)} pushSupported={push.supported} pushSubscribed={push.subscribed} pushPermission={push.permission} pushToggling={push.toggling} onPushToggle={push.toggle} />} />
