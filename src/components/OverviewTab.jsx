...
function Card({ icon, iconBg, label, primary, secondary, onClick, confetti = false, className = '', dot = false }) {
  return (
    <motion.button
      onClick={onClick}
      className={`relative overflow-hidden w-full flex items-center gap-4 bg-white rounded-2xl p-4 border border-stone-200 shadow-sm active:bg-stone-50 transition-colors text-left ${className}`}
...
function CardSkeleton({ delay = 0 }) {
  return (
    <div
      className="w-full flex items-center gap-4 bg-white rounded-2xl p-4 border border-stone-200 shadow-sm animate-pulse"
