    ...
    <div className="bg-white rounded-2xl shadow-md px-3 pt-3 pb-3 relative">
      ...
      <div className="flex items-end gap-2 relative z-10">
        ...
        <textarea
          ...
          placeholder="Message…"
          rows={1}
          className="flex-1 resize-none bg-stone-100 border-0 rounded-2xl px-4 py-2.5 text-stone-800 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-ember"
