...
const RotationTab = forwardRef(function RotationTab({ config, revealKey, groupName = '', displayName = '', onOpenSettings, isAdmin = false, compact = false, cutoffDate }, ref) {
  ...
  if (loading) {
    return (
      <div className="max-w-3xl mx-auto px-4 pb-12 flex items-center justify-center py-16">
    ...
    <>
      ...
      {showManagePages && (
        <ManagePagesModal
          ...
          onReorder={isAdmin ? handleReorderPages : undefined}
          onAddPage={isAdmin ? () => setShowAddModal(true) : undefined}
          onDeletePage={isAdmin ? async (pageId) => {
