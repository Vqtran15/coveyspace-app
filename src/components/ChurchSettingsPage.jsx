      ...
      <div ref={scrollBodyRef} className="flex-1 overflow-y-auto overscroll-contain">
        ...
        >
          ...
          {groupsInChurch.length > 1 && (
            <div className="bg-white rounded-2xl border border-stone-100 shadow px-4 py-4 space-y-3">
          ...
          {previewMode ? (
            <>
              {editorEmpty ? (
                <div className="bg-white rounded-2xl border border-stone-100 shadow px-5 py-8 text-center">
            ...
            <div className="bg-white rounded-2xl border border-stone-100 shadow overflow-hidden focus-within:ring-2 focus-within:ring-ember focus-within:border-transparent transition-all">
