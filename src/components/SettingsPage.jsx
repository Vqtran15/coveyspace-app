...
useEffect(() => {
  ...
  return (
    ...
    <main className="max-w-md lg:max-w-3xl mx-auto px-4 pt-8 pb-12">
      ...
      <div className="mb-4">
        <div className="bg-white border border-stone-200 rounded-2xl shadow-sm p-4 flex items-center gap-4">
      ...
      <div className="mb-4">
        <button
          ...
          className="w-full flex items-center gap-3 bg-white border border-stone-200 rounded-2xl shadow-sm px-4 py-3 mb-2"
