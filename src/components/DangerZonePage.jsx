  ...
  return (
    <main className="max-w-md mx-auto px-4 pt-8 pb-12">
      ...
      <div className="mb-4">
        ...
        <div className="bg-white border border-stone-100 rounded-2xl shadow p-4 space-y-3">
      ...
      <div className="mb-4">
        ...
        <div className="bg-white border border-red-100 rounded-2xl shadow p-4 space-y-3">
          <div className="flex items-start gap-3">
