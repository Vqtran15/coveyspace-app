  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'slide-in-up': {
          '0%':   { opacity: '0', transform: 'translateY(56px) scale(0.97)' },
        ...
        'celebration': {
          ...
          '45%':  { transform: 'scale(1.4) rotate(10deg)', opacity: '1' },
      ...
      animation: {
        ...
        'sheet-in':         'sheet-in 0.32s cubic-bezier(0.32,0.72,0,1) backwards',
        ...
        'slide-in-right':   'slide-in-right 0.34s cubic-bezier(0.25,0.46,0.45,0.94) backwards',
        'slide-in-left':    'slide-in-left 0.34s cubic-bezier(0.25,0.46,0.45,0.94) backwards',
        'slide-in-up':      'slide-in-up 0.38s cubic-bezier(0.25,0.46,0.45,0.94) backwards',
        ...
        'stack-in':         'stack-in 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) backwards',
